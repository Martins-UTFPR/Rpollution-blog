...
Como temos muitas variáveis climáticas para analisar, para facilitar a visualização, eu montei um [dashboard com todos os gráficos](https://www.rpollution.com/flexdashboards/ozonio-clima-sp/dash-ozonio-clima-sp.html). A seguir, os principais comentários.
