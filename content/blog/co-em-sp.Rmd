...
- durante a semana, há dois picos de ozônio durannte o dia, um de manhã, ~7h às ~11h, e outro à noite, ~18h ~0h, períodos de maior congestionamento na cidade;

- nos fins de semana, os picos da noite são mais acentuados, sendo que no domingo nem mesmo existe um pico pela manhã;

- em média, os níveis máximos de ozônio paracem estar por volta de 1.2 ppm ([partes por milhão](https://pt.wikipedia.org/wiki/Parte_por_milh%C3%A3o)) em todos os dias da semana.
...
Vamos agora considerar apenas os picos matinais, excluindo os fins de semana. A série horária da estação de Pinheiros está apresentada abaixo. Pela curva suavizada, observamos que a concentração de CO está diminuindo levemente ao longo dos anos. A principal explicação desse fenômeno é a mudança do padrão de emissão veicular. Apesar de termos mais veículos rodando na cidade, os veículos novos são menos poluentes. Mais informações sobre esse tema podem ser encontradas no artigo [Variations of Carbon Monoxide Concentrations in the Megacity of São Paulo from 2000 to 2015 in Different Time Scales](http://www.mdpi.com/2073-4433/8/5/81).
...
Por fim, apresentamos um mapa de calor da concentração de ozônio para os dados de 2018, sendo que as regiões mais quentes são aquelas com maior concentração média ao longo do ano.
